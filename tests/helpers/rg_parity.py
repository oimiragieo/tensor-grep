...
ROW_SCENARIOS: dict[str, _ScenarioSpec] = {
    ...
    "no-hidden": _ScenarioSpec("line number sentinel", ("line-number.txt",)),
    ...
    "pcre2-unicode": _ScenarioSpec("line number sentinel", ("line-number.txt",)),
    "ignore": _ScenarioSpec("line number sentinel", ("line-number.txt",)),
    "messages": _ScenarioSpec("line number sentinel", ("line-number.txt",)),
    "require-git": _ScenarioSpec("line number sentinel", ("line-number.txt",)),
