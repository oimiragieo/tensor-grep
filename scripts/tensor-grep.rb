...
class TensorGrep < Formula
  ...
  if OS.mac?
    url "https://github.com/oimiragieo/tensor-grep/releases/download/v0.12.0/tg-macos-amd64-cpu"
  elsif OS.linux?
    url "https://github.com/oimiragieo/tensor-grep/releases/download/v0.12.0/tg-linux-amd64-cpu"
  end
