...
class TensorGrep < Formula
  ...
  if OS.mac?
    url "https://github.com/oimiragieo/tensor-grep/releases/download/v0.10.1/tg-macos-amd64-cpu"
  elsif OS.linux?
    url "https://github.com/oimiragieo/tensor-grep/releases/download/v0.10.1/tg-linux-amd64-cpu"
  end
