...
try:
    ...
    with mock.patch("tensor_grep.backends.ast_backend.AstBackend.is_available", return_value=True):
        ...
        print(f"  Query: 'def process_data($DATA):'")
...
try:
    ...
    with mock.patch("torch.cuda.is_available", return_value=True), mock.patch("torch.device", return_value="cpu"):
        ...
        print(f"  Query: 'Database connection timeout'")
