...
- G2: Sanitization architecture — 38/38 tests pass in test_mcp_error_sanitization.py (PASS)
- G3: Confinement & fail-closed preservation — 93/93 tests pass across error sanitization and w1a fail closed suites (PASS)
