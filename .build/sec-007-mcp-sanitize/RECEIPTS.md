...
- G2: Sanitization architecture — 39/39 tests pass in test_mcp_error_sanitization.py (PASS)
- G3: Confinement & fail-closed preservation — 94/94 tests pass across error sanitization and w1a fail closed suites (PASS)
