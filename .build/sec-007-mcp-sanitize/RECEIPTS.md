...
## Gate Receipts
- G1: Scope verification — 52 AST str(exc) sites mapped across 3 modules post-sanitization (PASS)
- G2: Sanitization architecture — 24/24 tests pass in test_mcp_error_sanitization.py (PASS)
- G3: Confinement & fail-closed preservation — 79/79 tests pass across error sanitization and w1a fail closed suites (PASS)
