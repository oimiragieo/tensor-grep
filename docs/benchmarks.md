...
| --- | --- | --- |
| `tg run "def $FUNC():\n    $$$BODY" .` synthetic AST workflow | 0.279s | PASS |
| `tg scan --config sgconfig.yml` synthetic AST workflow | 0.304s | PASS |
| `tg test --config sgconfig.yml` synthetic AST workflow | 0.306s | PASS |
