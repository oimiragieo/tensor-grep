...
| --- | --- | --- |
| `tg run "def $FUNC():\n    $$$BODY" .` synthetic AST workflow | 0.287s | PASS |
| `tg scan --config sgconfig.yml` synthetic AST workflow | 0.300s | PASS |
| `tg test --config sgconfig.yml` synthetic AST workflow | 0.357s | PASS |
