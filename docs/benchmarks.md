...
| --- | --- | --- |
| `tg run "def $FUNC():\n    $$$BODY" .` synthetic AST workflow | 0.274s | PASS |
| `tg scan --config sgconfig.yml` synthetic AST workflow | 0.292s | PASS |
| `tg test --config sgconfig.yml` synthetic AST workflow | 0.354s | PASS |
