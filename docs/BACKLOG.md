...
> Last refreshed 2026-07-16 (backlog-steward tick). **Live PyPI is v1.76.13** (published; the v1.76.x
...
> Shipped 15 PRs: v1.76.0 #601 route-test / v1.76.1 #602 checkpoint-symlink / v1.76.2 #604 perf / v1.76.3 #603 daemon-guard /
...
> v1.76.13 #621 GPU-calibrate-honesty-nits (#612 gate NITs, #182); + #613 flaky-test-hardening + #616 help-contract-flake-fix (both no-release) -- PR queue EMPTY.
