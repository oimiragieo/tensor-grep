...
> Last refreshed 2026-07-15 (backlog-steward tick). **Live PyPI is v1.76.10** (published; the v1.76.x
...
> Shipped 11 PRs: v1.76.0 #601 route-test / v1.76.1 #602 checkpoint-symlink / v1.76.2 #604 perf / v1.76.3 #603 daemon-guard /
...
> v1.76.8 #611 checkpoint-symlink-disclosure (**security**) / v1.76.9 #612 GPU-calibrate-honesty / v1.76.10 #615 WSL-detection hardening (`/proc/version`); + #613 flaky-test hardening (no-release) -- PR queue EMPTY.
