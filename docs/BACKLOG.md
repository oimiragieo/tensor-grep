...
> Last refreshed 2026-07-22 (post-v1.93.0 — the CEO v1.92.1-dogfood "fix all + implement + dogfood" goal campaign, executed end-to-end with a published-wheel 7/7 dogfood verdict; prior: v1.92.2 world-class-tier #249 + deep-research #251). **Live PyPI is v1.93.0; v1.92.2 (#699) was still publishing at
...
## ⭐ CURRENT STATE (2026-07-22) — authoritative; every section BELOW is HISTORICAL until the next full refresh
