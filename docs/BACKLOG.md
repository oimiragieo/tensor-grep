...
> Last refreshed 2026-07-15 (backlog-steward tick). **Live PyPI is v1.76.6** (published; the v1.76.x
> "remaining AI-actionable backlog" wave #176 + a dogfood follow-up drained one-per-publish, ZERO broken releases).
> Shipped 7 PRs: v1.76.0 #601 route-test public / v1.76.1 #602 checkpoint-symlink / v1.76.2 #604 perf /
> v1.76.3 #603 daemon-guard / v1.76.4 #605 cuda-ceiling / v1.76.5 #606 orient-scope / v1.76.6 #608 agent-scope
> (dogfood-caught #606 sibling: tg agent/context-render still misdirected suggested_scope to .claude on the shipped v1.76.5 wheel) -- PR queue EMPTY.
