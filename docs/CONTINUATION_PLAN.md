...
- Latest verified proof public merge commit: `21e5437 fix: collect capsule call-site evidence`
...
- Main CI run `25951521056`: passed pre-release checks, semantic-release, `publish-github-release-assets`, `publish-pypi`, and `publish-success-gate`.
...
- CodeQL run `25951813292`: passed on the v1.12.14 release line.
- PyPI pinned public install: `uvx --refresh-package tensor-grep --from tensor-grep==1.12.14 tg --version` reports `tensor-grep 1.12.14`.
