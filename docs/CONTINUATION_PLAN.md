...
- Latest complete public merge commit: `b601366 fix: harden agent output budget hygiene`
...
- Main CI run `25948611239`: passed pre-release checks, semantic-release, `publish-github-release-assets`, `publish-pypi`, and `publish-success-gate`.
...
- CodeQL run `25949010544`: passed on the v1.12.12 release line.
- PyPI pinned public install: `uvx --refresh-package tensor-grep --from tensor-grep==1.12.12 tg --version` reports `tensor-grep 1.12.12`.
