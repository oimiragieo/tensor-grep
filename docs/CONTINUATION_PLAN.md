...
- Latest complete public merge commit: `bbc08e4 fix: harden rg flag contract aliases (#139)`
...
- Main CI run `25944371829`: passed pre-release checks, semantic-release, `publish-github-release-assets`, `publish-pypi`, and `publish-success-gate`.
...
- CodeQL run `25944371422`: passed on the v1.12.10 release line.
- PyPI pinned public install: `uvx --refresh-package tensor-grep --from tensor-grep==1.12.10 tg --version` reports `tensor-grep 1.12.10`.
