...
- Latest complete public merge commit: `2aebac6 fix: harden ast cli contract hygiene (#140)`
...
- Main CI run `25946534528`: passed pre-release checks, semantic-release, `publish-github-release-assets`, `publish-pypi`, and `publish-success-gate`.
...
- CodeQL run `25946912110`: passed on the v1.12.11 release line.
- PyPI pinned public install: `uvx --refresh-package tensor-grep --from tensor-grep==1.12.11 tg --version` reports `tensor-grep 1.12.11`.
