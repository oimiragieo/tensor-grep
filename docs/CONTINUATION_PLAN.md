...
- Latest complete public merge commit: `8a73f8d fix: harden agent bridge ranking`
...
- Main CI run `25950189993`: passed pre-release checks, semantic-release, `publish-github-release-assets`, `publish-pypi`, and `publish-success-gate`.
...
- CodeQL run `25950454736`: passed on the v1.12.13 release line.
- PyPI pinned public install: `uvx --refresh-package tensor-grep --from tensor-grep==1.12.13 tg --version` reports `tensor-grep 1.12.13`.
