...
**Status:** APPROVED — architecture, security, and TDD thinktank seats converged on `SHIP`; implementation may begin only from the exact final reviewed hashes.
