...
- [ ] **AGT-01** — Status: IN_FLIGHT; PR: PR #1160; Trigger: obtain reviewed real-repository holdout fixtures; Owner: Evaluation maintainer; `dd3c594` shipped the baseline metric, PR #1159 (`bb635941`) the fail-closed outcome join, and PR #1160 (`cc833b06`, v1.121.0) scorecard reporting without ranking changes; holdout curation remains fixture-blocked, so this mixed disposition is not SHIPPED; prerequisite: fixture authority; plan: docs/plans/2026-09-07-agentic-quality-simplification.md#task-01; Implementation PRs: PR #1159, PR #1160
