...
release_docs_current_tag: v1.12.9

- Latest tagged version: `v1.12.9`
- Latest complete PyPI version: `v1.12.9`
...
- GitHub release assets: `v1.12.9` has uploaded native CPU front doors for Windows/Linux/macOS, checksums, winget manifest, Homebrew formula, and publish instructions
...
Active post-`v1.12.9` implementation scope:
