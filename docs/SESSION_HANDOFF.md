...
- Latest tagged version: `v1.12.13`
- Latest complete PyPI version: `v1.12.13`
...
- GitHub release assets: `v1.12.13` has uploaded native CPU front doors for Windows/Linux/macOS, checksums, winget manifest, Homebrew formula, and publish instructions
...
Active post-`v1.12.13` implementation scope:
