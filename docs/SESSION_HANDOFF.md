...
release_docs_current_tag: v1.121.3

- Latest tagged version: `v1.121.3`
- Latest complete PyPI version: `v1.121.3`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.121.3>
...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.121.3 tg --version` reports `tensor-grep 1.121.3`
- GitHub release assets: `v1.121.3` has uploaded native CPU front doors for Windows/Linux/macOS, checksums, winget manifest, Homebrew formula, and publish instructions
