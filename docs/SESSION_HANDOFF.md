...
- Latest tagged version: `v1.11.7`
- Latest complete PyPI version: `v1.11.7`
...
- GitHub release assets: `v1.11.7` has uploaded native CPU front doors for Windows/Linux/macOS, checksums, winget manifest, Homebrew formula, and publish instructions
...
Active post-`v1.11.7` implementation scope:
