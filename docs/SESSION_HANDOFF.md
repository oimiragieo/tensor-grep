...
- Latest tagged version: `v1.12.0`
- Latest complete PyPI version: `v1.12.0`
...
- GitHub release assets: `v1.12.0` has uploaded native CPU front doors for Windows/Linux/macOS, checksums, winget manifest, Homebrew formula, and publish instructions
...
Active post-`v1.12.0` implementation scope:
