...
- Latest tagged version: `v1.119.6`
- Latest complete PyPI version: `v1.119.6`
...
- GitHub release assets: `v1.119.6` has uploaded native CPU front doors for Windows/Linux/macOS, checksums, winget manifest, Homebrew formula, and publish instructions
