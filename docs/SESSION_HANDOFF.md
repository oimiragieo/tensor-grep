...
- Latest tagged version: `v1.12.2`
- Latest complete PyPI version: `v1.12.2`
...
- GitHub release assets: `v1.12.2` has uploaded native CPU front doors for Windows/Linux/macOS, checksums, winget manifest, Homebrew formula, and publish instructions
...
Active post-`v1.12.2` implementation scope:
