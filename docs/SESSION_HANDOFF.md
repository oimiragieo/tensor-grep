...
- Latest tagged version: `v1.12.3`
- Latest complete PyPI version: `v1.12.3`
...
- GitHub release assets: `v1.12.3` has uploaded native CPU front doors for Windows/Linux/macOS, checksums, winget manifest, Homebrew formula, and publish instructions
...
Active post-`v1.12.3` implementation scope:
