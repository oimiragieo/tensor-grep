...
- Latest tagged version: `v1.12.14`
- Latest complete PyPI version: `v1.12.14`
...
- GitHub release assets: `v1.12.14` has uploaded native CPU front doors for Windows/Linux/macOS, checksums, winget manifest, Homebrew formula, and publish instructions
...
Active post-`v1.12.14` implementation scope:
