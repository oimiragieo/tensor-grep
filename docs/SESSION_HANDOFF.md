...
release_docs_current_tag: v1.119.15

- Latest tagged version: `v1.119.15`
- Latest complete PyPI version: `v1.119.15`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.119.15>
...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.119.15 tg --version` reports `tensor-grep 1.119.15`
- GitHub release assets: `v1.119.15` has uploaded native CPU front doors for Windows/Linux/macOS, checksums, winget manifest, Homebrew formula, and publish instructions
