...
release_docs_current_tag: v1.119.2

- Latest tagged version: `v1.119.2`
- Latest complete PyPI version: `v1.119.2`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.119.2>
...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.119.2 tg --version` reports `tensor-grep 1.119.2`
- GitHub release assets: `v1.119.2` has uploaded native CPU front doors for Windows/Linux/macOS, checksums, winget manifest, Homebrew formula, and publish instructions
