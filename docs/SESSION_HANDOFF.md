...
release_docs_current_tag: v1.12.33

- Latest tagged version: `v1.12.33`
- Latest complete PyPI version: `v1.12.33`
...
- Latest fix commit: `21e5437 fix: collect capsule call-site evidence`
- Latest feature commit: `a518cc6 feat: add agent success harness`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.12.33>
...
- Main CI run `25951521056`: passed the pre-release matrix, semantic-release, `publish-github-release-assets`, `publish-pypi`, and `publish-success-gate`
...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.12.33 tg --version` reports `tensor-grep 1.12.33`
- GitHub release assets: `v1.12.33` has uploaded native CPU front doors for Windows/Linux/macOS, checksums, winget manifest, Homebrew formula, and publish instructions
...
Active post-`v1.12.33` implementation scope:
