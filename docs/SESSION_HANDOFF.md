...
release_docs_current_tag: v1.12.20

- Latest tagged version: `v1.12.20`
- Latest complete PyPI version: `v1.12.20`
...
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.12.20>
...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.12.20 tg --version` reports `tensor-grep 1.12.20`
- GitHub release assets: `v1.12.20` has uploaded native CPU front doors for Windows/Linux/macOS, checksums, winget manifest, Homebrew formula, and publish instructions
...
Active post-`v1.12.20` implementation scope:
