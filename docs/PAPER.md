...
7. **Direct file writes**: replaced atomic temp-file+rename with direct writes (matching sg's approach)
8. **Removed sync_all per file**: eliminated per-file fsync for rewrite throughput
