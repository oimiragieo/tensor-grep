...
* **Patch benchmark track:**
  synthetic end-to-end patch scoring is now implemented, but the current headless Gemini and Copilot patch generators are still too unstable to count as accepted comparative wins
