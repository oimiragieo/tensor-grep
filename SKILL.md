...
- Current release tag: `v1.101.31`.
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.101.31>.
- PyPI/public install proof: `uvx --refresh-package tensor-grep --from tensor-grep==1.101.31 tg --version` reports `tensor-grep 1.101.31`.
