...
- Current release tag: `v1.51.7`.
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.51.7>.
- PyPI/public install proof: `uvx --refresh-package tensor-grep --from tensor-grep==1.51.7 tg --version` reports `tensor-grep 1.51.7`.
