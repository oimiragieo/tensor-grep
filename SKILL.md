...
- Current release tag: `v1.81.6`.
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.81.6>.
- PyPI/public install proof: `uvx --refresh-package tensor-grep --from tensor-grep==1.81.6 tg --version` reports `tensor-grep 1.81.6`.
