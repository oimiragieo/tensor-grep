...
- Current release tag: `v1.45.10`.
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.45.10>.
- PyPI/public install proof: `uvx --refresh-package tensor-grep --from tensor-grep==1.45.10 tg --version` reports `tensor-grep 1.45.10`.
