...
- Current release tag: `v1.63.4`.
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.63.4>.
- PyPI/public install proof: `uvx --refresh-package tensor-grep --from tensor-grep==1.63.4 tg --version` reports `tensor-grep 1.63.4`.
