...
- Current release tag: `v1.101.29`.
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.101.29>.
- PyPI/public install proof: `uvx --refresh-package tensor-grep --from tensor-grep==1.101.29 tg --version` reports `tensor-grep 1.101.29`.
