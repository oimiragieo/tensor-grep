...
- Current release tag: `v1.17.24`.
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.17.24>.
- PyPI/public install proof: `uvx --refresh-package tensor-grep --from tensor-grep==1.17.24 tg --version` reports `tensor-grep 1.17.24`.
