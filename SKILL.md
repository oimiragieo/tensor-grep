...
- Current release tag: `v1.13.43`.
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.13.43>.
- PyPI/public install proof: `uvx --refresh-package tensor-grep --from tensor-grep==1.13.43 tg --version` reports `tensor-grep 1.13.43`.
