...
- Current release tag: `v1.80.2`.
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.80.2>.
- PyPI/public install proof: `uvx --refresh-package tensor-grep --from tensor-grep==1.80.2 tg --version` reports `tensor-grep 1.80.2`.
