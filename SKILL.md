...
- Current release tag: `v1.98.3`.
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.98.3>.
- PyPI/public install proof: `uvx --refresh-package tensor-grep --from tensor-grep==1.98.3 tg --version` reports `tensor-grep 1.98.3`.
