...
- Current release tag: `v1.30.1`.
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.30.1>.
- PyPI/public install proof: `uvx --refresh-package tensor-grep --from tensor-grep==1.30.1 tg --version` reports `tensor-grep 1.30.1`.
