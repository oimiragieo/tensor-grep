...
- Current release tag: `v1.76.1`.
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.76.1>.
- PyPI/public install proof: `uvx --refresh-package tensor-grep --from tensor-grep==1.76.1 tg --version` reports `tensor-grep 1.76.1`.
