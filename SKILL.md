...
- Current release tag: `v1.13.47`.
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.13.47>.
- PyPI/public install proof: `uvx --refresh-package tensor-grep --from tensor-grep==1.13.47 tg --version` reports `tensor-grep 1.13.47`.
