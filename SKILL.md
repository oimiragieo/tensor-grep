...
- Latest verified release proof: PR #229 `fix: harden v1.13.17 dogfood followups`; merge commit `77a73b2 fix: harden v1.13.17 dogfood followups (#229)`; release commit `4a0dad0 chore(release): v1.13.18 [skip ci]`; main CI run `26425383595`; main dynamic/CodeQL run `26425914836`.
