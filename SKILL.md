...
- Current release tag: `v1.76.11`.
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.76.11>.
- PyPI/public install proof: `uvx --refresh-package tensor-grep --from tensor-grep==1.76.11 tg --version` reports `tensor-grep 1.76.11`.
