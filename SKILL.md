...
- Current release tag: `v1.119.10`.
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.119.10>.
- PyPI/public install proof: `uvx --refresh-package tensor-grep --from tensor-grep==1.119.10 tg --version` reports `tensor-grep 1.119.10`.
