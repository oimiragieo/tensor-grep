...
- Current release tag: `v1.72.0`.
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.72.0>.
- PyPI/public install proof: `uvx --refresh-package tensor-grep --from tensor-grep==1.72.0 tg --version` reports `tensor-grep 1.72.0`.
