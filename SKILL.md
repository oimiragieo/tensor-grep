...
- Current release tag: `v1.101.12`.
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.101.12>.
- PyPI/public install proof: `uvx --refresh-package tensor-grep --from tensor-grep==1.101.12 tg --version` reports `tensor-grep 1.101.12`.
