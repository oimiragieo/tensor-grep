...
- Current release tag: `v1.81.19`.
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.81.19>.
- PyPI/public install proof: `uvx --refresh-package tensor-grep --from tensor-grep==1.81.19 tg --version` reports `tensor-grep 1.81.19`.
