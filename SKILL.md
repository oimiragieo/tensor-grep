...
- Current release tag: `v1.110.12`.
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.110.12>.
- PyPI/public install proof: `uvx --refresh-package tensor-grep --from tensor-grep==1.110.12 tg --version` reports `tensor-grep 1.110.12`.
