...
- Current release tag: `v1.119.14`.
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.119.14>.
- PyPI/public install proof: `uvx --refresh-package tensor-grep --from tensor-grep==1.119.14 tg --version` reports `tensor-grep 1.119.14`.
