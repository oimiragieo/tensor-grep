...
- Current release tag: `v1.55.0`.
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.55.0>.
- PyPI/public install proof: `uvx --refresh-package tensor-grep --from tensor-grep==1.55.0 tg --version` reports `tensor-grep 1.55.0`.
