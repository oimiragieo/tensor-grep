...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.28.4 tg --version` reports `tensor-grep 1.28.4`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.28.4>
...
Current post-`v1.28.4` dogfood slice ledger:
