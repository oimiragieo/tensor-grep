...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.13.40 tg --version` reports `tensor-grep 1.13.40`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.13.40>
...
Current post-`v1.13.40` dogfood slice ledger:
