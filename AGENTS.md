...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.12.45 tg --version` reports `tensor-grep 1.12.45`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.12.45>
...
Current post-`v1.12.45` dogfood slice ledger:
