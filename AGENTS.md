...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.17.4 tg --version` reports `tensor-grep 1.17.4`
...
Current post-`v1.17.4` dogfood slice ledger:
