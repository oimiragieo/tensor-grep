...
## Current Handoff
release_docs_current_tag: v1.110.17
...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.110.17 tg --version` reports `tensor-grep 1.110.17`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.110.17>
