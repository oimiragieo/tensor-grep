...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.99.2 tg --version` reports `tensor-grep 1.99.2`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.99.2>
