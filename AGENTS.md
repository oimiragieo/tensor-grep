...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.51.10 tg --version` reports `tensor-grep 1.51.10`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.51.10>
