...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.17.18 tg --version` reports `tensor-grep 1.17.18`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.17.18>
...
Current post-`v1.17.18` dogfood slice ledger:
