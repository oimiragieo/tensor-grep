...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.45.14 tg --version` reports `tensor-grep 1.45.14`
...
Current post-`v1.45.14` dogfood slice ledger:
