...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.12.42 tg --version` reports `tensor-grep 1.12.42`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.12.42>
...
Current post-`v1.12.42` dogfood slice ledger:
