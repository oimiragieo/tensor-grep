...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.13.28 tg --version` reports `tensor-grep 1.13.28`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.13.28>
...
Current post-`v1.13.28` dogfood slice ledger:
