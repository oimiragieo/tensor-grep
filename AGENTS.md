...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.17.11 tg --version` reports `tensor-grep 1.17.11`
...
Current post-`v1.17.11` dogfood slice ledger:
