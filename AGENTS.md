...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.102.8 tg --version` reports `tensor-grep 1.102.8`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.102.8>
