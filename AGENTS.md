...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.49.0 tg --version` reports `tensor-grep 1.49.0`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.49.0>
...
Current post-`v1.49.0` dogfood slice ledger:
