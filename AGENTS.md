...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.51.6 tg --version` reports `tensor-grep 1.51.6`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.51.6>
...
Current post-`v1.51.6` dogfood slice ledger:
