...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.81.21 tg --version` reports `tensor-grep 1.81.21`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.81.21>
