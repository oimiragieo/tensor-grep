...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.13.19 tg --version` reports `tensor-grep 1.13.19`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.13.19>
...
Current post-`v1.13.19` dogfood slice ledger:
