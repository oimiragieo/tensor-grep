...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.12.35 tg --version` reports `tensor-grep 1.12.35`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.12.35>
...
Current post-`v1.12.35` dogfood slice ledger:
