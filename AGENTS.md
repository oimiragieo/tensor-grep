...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.70.0 tg --version` reports `tensor-grep 1.70.0`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.70.0>
