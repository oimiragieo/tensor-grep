...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.24.0 tg --version` reports `tensor-grep 1.24.0`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.24.0>
...
Current post-`v1.24.0` dogfood slice ledger:
