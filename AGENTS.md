...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.17.15 tg --version` reports `tensor-grep 1.17.15`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.17.15>
...
Current post-`v1.17.15` dogfood slice ledger:
