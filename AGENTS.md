...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.92.3 tg --version` reports `tensor-grep 1.92.3`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.92.3>
