...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.17.10 tg --version` reports `tensor-grep 1.17.10`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.17.10>
...
Current post-`v1.17.10` dogfood slice ledger:
