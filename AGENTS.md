...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.65.1 tg --version` reports `tensor-grep 1.65.1`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.65.1>
