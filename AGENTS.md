...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.13.43 tg --version` reports `tensor-grep 1.13.43`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.13.43>
...
Current post-`v1.13.43` dogfood slice ledger:
