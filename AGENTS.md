...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.12.47 tg --version` reports `tensor-grep 1.12.47`
...
Current post-`v1.12.47` dogfood slice ledger:
