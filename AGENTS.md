...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.39.1 tg --version` reports `tensor-grep 1.39.1`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.39.1>
...
Current post-`v1.39.1` dogfood slice ledger:
