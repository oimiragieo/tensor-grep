...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.28.7 tg --version` reports `tensor-grep 1.28.7`
...
Current post-`v1.28.7` dogfood slice ledger:
