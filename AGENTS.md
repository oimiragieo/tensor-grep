...
release_docs_current_tag: v1.62.2
...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.62.2 tg --version` reports `tensor-grep 1.62.2`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.62.2>
