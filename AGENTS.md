...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.12.36 tg --version` reports `tensor-grep 1.12.36`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.12.36>
...
Current post-`v1.12.36` dogfood slice ledger:
