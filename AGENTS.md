...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.13.47 tg --version` reports `tensor-grep 1.13.47`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.13.47>
...
Current post-`v1.13.47` dogfood slice ledger:
