...
## Current Handoff
release_docs_current_tag: v1.111.1
...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.111.1 tg --version` reports `tensor-grep 1.111.1`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.111.1>
