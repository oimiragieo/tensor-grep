...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.19.9 tg --version` reports `tensor-grep 1.19.9`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.19.9>
...
Current post-`v1.19.9` dogfood slice ledger:
