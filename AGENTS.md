...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.15.1 tg --version` reports `tensor-grep 1.15.1`
...
Current post-`v1.15.1` dogfood slice ledger:
