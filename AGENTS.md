...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.45.15 tg --version` reports `tensor-grep 1.45.15`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.45.15>
...
Current post-`v1.45.15` dogfood slice ledger:
