...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.98.9 tg --version` reports `tensor-grep 1.98.9`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.98.9>
