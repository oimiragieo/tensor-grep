...
- Main CI run `26425383595`: passed the pre-release matrix, semantic-release, PyPI artifact validation, `publish-github-release-assets`, `publish-pypi`, and `publish-success-gate`
- Main dynamic/CodeQL run `26425914836`: passed on the `4a0dad0` release commit
- Release commit `4a0dad0`: published `v1.13.18` with `[skip ci]` after main CI completed
