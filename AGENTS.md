...
- PyPI pinned install: `uvx --refresh-package tensor-grep --from tensor-grep==1.76.5 tg --version` reports `tensor-grep 1.76.5`
- GitHub release: <https://github.com/oimiragieo/tensor-grep/releases/tag/v1.76.5>
