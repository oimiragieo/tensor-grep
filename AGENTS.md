...
- Latest merged fix commit: `b69bc5b fix: harden upgrade daemon and lsp diagnostics (#233)`
...
- Main CI run `26450640497`: passed the pre-release matrix, semantic-release, PyPI artifact validation, `publish-github-release-assets`, `publish-pypi`, and `publish-success-gate`
- Main dynamic/CodeQL run `26450639894`: passed on the `b69bc5b` merge commit
