...
Date-stamped **2026-07-16, v1.78.1** (originally authored 2026-07-02 at v1.17.25; spot-checked 2026-07-08
at v1.49.3). This pass re-verified the Problem 4b (`#74` file-deps) re-proof and the Problem 1 GPU-funding
note only — the rest was not re-walked line-by-line. Re-verify volatile facts with the commands in
...
- **Version / date stamp** (`v1.78.1`, 2026-07-16): `grep -n '^version' pyproject.toml` and `grep -n 'release_docs_current_tag' AGENTS.md`.
